      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-6">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p>
                  1. Usia 17 sampai dengan 60 <br>
                  2. Berat badan minimal 45 kg <br>
                  3. Tekanan Darah Sistolik 100- 160 <br>
                  4. Kadar Hemoglobin 12,5 dL <br>
                  5. Suhu tubuh 36-37 derajat Celcius <br>
                  6. Jarak Penyumbangan darah mak 3 bulan <br>
                  7. Untuk wanita haid dan hamil dilarang donor <br>
                </p>
          ...
          <div class="col-lg-6">
            <div class="card">
              <div class="card-header">
                <h5 >Syarat Permintaan Darah</h5>
              </div>
              <div class="card-body">                

                <p class="card-text">
                  1. Ketahui dulu golongan darah pasien <br>
                  2. Meminta surat keterangan dokter rumah sakit <br>
                  3. Serahkan surat keterangan kepada UTD <br>
                </p>                
              </div>
            </div>            
          </div>
