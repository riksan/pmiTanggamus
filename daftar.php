          ...
          <div class="col-lg-6">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="card-text">Apakah anda sudah pernah daftar sebelumnya?</p>
                <a href="daftar2.php" class="btn btn-primary">Ya</a>
                <a href="daftarbaru.php" class="btn btn-danger">Tidak</a>
              </div>
            </div>
