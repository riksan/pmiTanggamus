    ...
    <div class="sidebar">      
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item">
            <a href="adminberanda.php" class="nav-link active">
        ...
        <div class="row">
          <div class="col-lg-10">
            <div class="card">
              <div class="card-body">
                <p class="card-text">
                  Selamat Datang di Halaman Admin website PMI Tanggamus 
                  Anda dapat melihat pendaftar donor darah dan verifikasi pendonor
                  Anda juga dapat melakukan iput darah, input jadwal kegiatan donor darah 
                  anda dapat melakukan pengelolaan permintaan darah selain itu juga anda dapat melakukan penginputan Rumah sakit baru
                </p>
...
<script src="../ist/js/pages/dashboard.js"></script>
</body>
</html>
