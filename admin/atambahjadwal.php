        ...
        <div class="row">
          <div class="col-6">
            <div class="card">
              ...
              <div class="card-body">
                <form method="POST" action="../proses/ptambah_jadwal.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="tanggal_kegiatan" placeholder="">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="lokasi_kegiatan" placeholder="">
                </div>
                <div class="form-group">
