          ...
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <table id="example" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="aeditjadwal.php?id_kegiatan=<?php echo $row['id_kegiatan']; ?>" class="btn btn-warning">Edit</a>
                        <a href="../proses/phapus_jadwal.php?id_kegiatan=<?php echo $row['id_kegiatan']; ?>" class="btn btn-danger">Hapus</a>
                      </td>
                    </tr>
                    <?php 
                    $no++;
                ...
                <br>
                <a href="atambahjadwal.php" class="btn btn-primary">Tambah</a>
              </div>
            </div>
          </div>
        </div>
