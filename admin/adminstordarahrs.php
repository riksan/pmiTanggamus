    ...
    <div class="sidebar">      
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="adminstordarahrs.php" class="nav-link active">
              <i class="nav-icon fas fa-copy"></i>
              <p>
                Stor Darah RS
              </p>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Stor Darah Rumah Sakit</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active"><a href="index.php">Halaman Utama</a></li>
              <li class="breadcrumb-item active">Stor Darah Rumah Sakit</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
        <form method="POST" action="../proses/pstor_darah.php" enctype="multipart/form-data">
        <div class="row">
          <div class="col-6">
            <div class="card">
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control " name= "id_rumah_sakit" style="width: 100%;">
                    <option disabled selected>Pilih Rumah Sakit</option>
                      <?php 
                      $query2 = "SELECT * FROM tb_rumah_sakit";
                      ...
                      ?>
                    <option value="<?php echo $row2['id_rumah_sakit'] ; ?>">
                      <?php echo $row2['nama_rumah_sakit'] ;?>
                    </option>
                      <?php } ?>
                  </select>
                </div>
