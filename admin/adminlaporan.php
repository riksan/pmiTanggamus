  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Laporan - Laporan</h1>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-7">
            <div class="card">
              <div class="card-body">
                <a href="l_kegiatan_donor.php" class="btn btn-danger">Laporan Kegiatan Donor</a>
                <a href="laporan_permintaandarah.php" class="btn btn-danger">Laporan Permintaan Darah</a>
                <a href="l_darah_masuk.php" class="btn btn-danger">Laporan Darah Masuk</a>
              </div>
            </div>
            <!-- /.card -->
          </div>
